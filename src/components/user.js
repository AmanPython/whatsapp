...
const Chat = () => {
  ...
  const { auth_token } = history.location.state;
  ...
  console.log("returned_state_object", returned_state_string);
    ...
    <div>
      ...
      <Grid container component={Paper} className={classes.chatSection}>
        <Grid item xs={3} className={classes.borderRight500}>
          ...
          <Divider />
          <List>
            {roomData?.map((eachSection, index) => {
              return (
                <ListItem button key="RemySharp">
                  <ListItemIcon>
                    <Avatar
                  ...
                  <ListItemText primary={eachSection?.roomname}>
                    Remy Sharp
                  </ListItemText>
        ...
        <Grid item xs={9}>
          ...
          <Grid container style={{ padding: "20px" }}>
            ...
            <Grid xs={1} align="right">
              <Fab color="primary" aria-label="add" onClick={getData}>
                <SendIcon />
              </Fab>
            </Grid>
          </Grid>
